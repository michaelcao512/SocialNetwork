...
function DisplayReactions({
    ...
    const serviceMap = {
        post: {
            ...
            getDislikeCount: () =>
                reactionsService.getDislikeCountByPostId(entityId),
            getReaction: () =>
                reactionsService.getReactionByPostIdAndAccountId(
                    entityId,
                    user.id
                ),
            createReaction: (type) =>
            ...
            getCommentCount: () =>
                commentService.getCommentsCountByPostId(entityId),
        },
        comment: {
            getLikeCount: () =>
                reactionsService.getLikeCountByCommentId(entityId),
            getDislikeCount: () =>
                reactionsService.getDislikeCountByCommentId(entityId),
            getReaction: () =>
                reactionsService.getReactionByCommentIdAndAccountId(
                    entityId,
                    user.id
                ),
            createReaction: (type) =>
            ...
            deleteReaction: (reactionId) =>
                reactionsService.deleteCommentReaction(reactionId),
            getCommentCount: () =>
                commentService.getCommentsCountByCommentId(entityId),
        },
    };
    ...
    return (
        <ReactionsContainer>
            <Box display="flex" alignItems="center">
                <ReactionIconButton
                    className={
                        reaction?.reactionType === "LIKE" ? "active" : ""
                    }
                ...
                >
                    ...
                    <IndentedTypography variant="body2">
                        {numLikes}
                    </IndentedTypography>
                </ReactionIconButton>
            </Box>
            <Box display="flex" alignItems="center">
                <ReactionIconButton
                    className={
                        reaction?.reactionType === "DISLIKE" ? "active" : ""
                    }
